import { r as requireReact, g as getDefaultExportFromCjs, a as requireReactDom } from "./vendor-react-BoEpX7VO.js";
...
var _excluded$u = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function _extends$y() {
...
var Surface = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  var {
    ...
    title,
    desc
  } = props, others = _objectWithoutProperties$u(props, _excluded$u);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  return /* @__PURE__ */ reactExports.createElement("svg", _extends$y({}, svgPropertiesAndEvents(others), {
...
var _excluded$s = ["type", "size", "sizeType"];
function _extends$w() {
...
var Symbols = (_ref2) => {
  var {
    ...
    size = 64,
    sizeType = "area"
  } = _ref2, rest = _objectWithoutProperties$s(_ref2, _excluded$s);
...
class TooltipBoundingBox extends reactExports.PureComponent {
  ...
  render() {
    ...
    var positionStyles = hasPortalFromProps ? {} : _objectSpread$B(_objectSpread$B({
    ...
    var outerStyle = _objectSpread$B(_objectSpread$B({}, positionStyles), {}, {
      visibility: !this.state.dismissed && active && hasPayload ? "visible" : "hidden"
    }, wrapperStyle);
    return (
...
var Curve = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$u({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
    className: clsx("recharts-curve", className),
    d: realPath === null ? void 0 : realPath,
    ref: pathRef
  }));
};
var _excluded$r = ["x", "y", "top", "left", "width", "height", "className"];
function _extends$t() {
...
var Cross = (_ref2) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$t({}, svgPropertiesAndEvents(props), {
...
var _excluded$q = ["radius"], _excluded2$c = ["radius"];
...
var getRectanglePath = (x2, y2, width, height, radius) => {
  ...
  if (maxRadius > 0 && radius instanceof Array) {
    ...
    path = roundTemplateLiteral(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral$3(["M", ",", ""])), x2, y2 + ySign * newRadius[0]);
    if (newRadius[0] > 0) {
      path += roundTemplateLiteral(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral$3(["A ", ",", ",0,0,", ",", ",", ""])), newRadius[0], newRadius[0], clockWise, x2 + xSign * newRadius[0], y2);
    }
    path += roundTemplateLiteral(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral$3(["L ", ",", ""])), x2 + width - xSign * newRadius[1], y2);
    if (newRadius[1] > 0) {
    ...
    path += roundTemplateLiteral(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral$3(["L ", ",", ""])), x2 + width, y2 + height - ySign * newRadius[2]);
    if (newRadius[2] > 0) {
    ...
    path += roundTemplateLiteral(_templateObject7$1 || (_templateObject7$1 = _taggedTemplateLiteral$3(["L ", ",", ""])), x2 + xSign * newRadius[3], y2 + height);
    if (newRadius[3] > 0) {
    ...
    path = roundTemplateLiteral(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral$3(["M ", ",", " h ", " v ", " h ", " Z"])), x2, y2, width, height, -width);
  }
  return path;
};
...
var Rectangle = (rectangleProps) => {
  ...
  if (!isUpdateAnimationActive) {
    var _svgPropertiesAndEven = svgPropertiesAndEvents(props), {
      radius: _
    } = _svgPropertiesAndEven, otherPathProps = _objectWithoutProperties$q(_svgPropertiesAndEven, _excluded$q);
    return /* @__PURE__ */ reactExports.createElement("path", _extends$s({}, otherPathProps, {
      x: round$1(x2),
      y: round$1(y2),
      width: round$1(width),
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), {
      radius: _2
    } = _svgPropertiesAndEven2, otherPathProps2 = _objectWithoutProperties$q(_svgPropertiesAndEven2, _excluded2$c);
    return /* @__PURE__ */ reactExports.createElement("path", _extends$s({}, otherPathProps2, {
      radius: typeof radius === "number" ? radius : void 0,
      className: layerClass,
...
function Cursor(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(CursorInternal, _extends$q({}, props, {
    offset,
    layout,
    tooltipAxisBandSize,
    chartName
      ...
      if (syncMethod === "index") {
        ...
        if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
          var _action$payload$coord = action.payload.coordinate, {
            x: _x,
            y: _y
          } = _action$payload$coord, otherCoordinateProps = _objectWithoutProperties$p(_action$payload$coord, _excluded$p);
          var {
            x: sourceX,
            y: sourceY,
            width: sourceWidth,
...
function Tooltip(outsideProps) {
  ...
  }, renderContent(content, _objectSpread$m(_objectSpread$m({}, props), {}, {
...
var _excluded$o = ["x", "y", "lineHeight", "capHeight", "fill", "scaleToFit", "textAnchor", "verticalAnchor"], _excluded2$b = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$p() {
...
var Text = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  var _resolveDefaultProps = resolveDefaultProps(outsideProps, textDefaultProps), {
    ...
    textAnchor,
    verticalAnchor
  } = _resolveDefaultProps, props = _objectWithoutProperties$o(_resolveDefaultProps, _excluded$o);
  ...
  var {
    ...
    className,
    breakAll
  } = props, textProps = _objectWithoutProperties$o(props, _excluded2$b);
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$p({}, svgPropertiesAndEvents(textProps), {
    ref,
    x: x2,
    y: y2,
...
var _excluded$n = ["labelRef"], _excluded2$a = ["content"];
...
var renderRadialLabel = (labelProps, position, label, attrs, viewBox) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$o({}, attrs, {
...
function Label(outerProps) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(content)) {
    var {
      labelRef: _
    } = propsWithViewBox, propsWithoutLabelRef = _objectWithoutProperties$n(propsWithViewBox, _excluded$n);
    return /* @__PURE__ */ reactExports.cloneElement(content, propsWithoutLabelRef);
  }
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties$n(propsWithViewBox, _excluded2$a);
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex: props.zIndex
  }, /* @__PURE__ */ reactExports.createElement(Text, _extends$o({
    ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (label === true) {
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$o({
      key: "label-implicit"
    }, commonProps));
  }
  if (isNumOrStr(label)) {
  ...
  if (label && typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$o({}, label, {
      key: "label-implicit"
    }, commonProps));
  }
  return null;
...
var _excluded$m = ["valueAccessor"], _excluded2$9 = ["dataKey", "clockWise", "id", "textBreakAll", "zIndex"];
function _extends$n() {
...
function LabelList(_ref2) {
  ...
  } = _ref2, restProps = _objectWithoutProperties$m(_ref2, _excluded$m);
  var {
    dataKey,
    clockWise,
    id,
    textBreakAll,
    zIndex
  } = restProps, others = _objectWithoutProperties$m(restProps, _excluded2$9);
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    ...
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$n({
...
function LabelListFromLabelProp(_ref2) {
  ...
  if (typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(LabelList, _extends$n({
      key: "labelList-implicit"
    }, label, {
...
var _excluded$l = ["points", "className", "baseLinePoints", "connectNulls"];
...
var getSinglePolygonPath = (points, connectNulls) => {
  ...
  var polygonPath = segmentPoints.map((segPoints) => {
    return segPoints.reduce((path, point2, index) => {
      return roundTemplateLiteral(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral$1(["", "", "", ",", ""])), path, index === 0 ? "M" : "L", point2.x, point2.y);
    }, "");
  }).join("");
...
var Polygon = (props) => {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ reactExports.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ reactExports.createElement("path", _extends$m({}, svgPropertiesAndEvents(others), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ reactExports.createElement("path", _extends$m({}, svgPropertiesAndEvents(others), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ reactExports.createElement("path", _extends$m({}, svgPropertiesAndEvents(others), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ reactExports.createElement("path", _extends$m({}, svgPropertiesAndEvents(others), {
...
var Dot = (props) => {
  ...
  if (isNumber(cx) && isNumber(cy) && isNumber(r2)) {
    return /* @__PURE__ */ reactExports.createElement("circle", _extends$l({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r: r2
...
var selectPolarGridAngles = createSelector([selectAngleAxisTicks$1], (ticks2) => {
  if (!ticks2) {
    return void 0;
  }
...
var selectPolarGridRadii = createSelector([selectRadiusAxisTicks$1], (ticks2) => {
  if (!ticks2) {
    return void 0;
  }
  return ticks2.map((tick) => tick.coordinate);
});
var _excluded$k = ["gridType", "radialLines", "angleAxisId", "radiusAxisId", "cx", "cy", "innerRadius", "outerRadius", "polarAngles", "polarRadius"];
...
var PolarAngles = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("g", {
    ...
    return /* @__PURE__ */ reactExports.createElement("line", _extends$k({
...
var ConcentricCircle = (props) => {
  ...
  var concentricCircleProps = _objectSpread$j({
    stroke: "#ccc",
    fill: "none"
  }, svgPropertiesNoEvents(props));
  return (
    // @ts-expect-error wrong SVG element type
    /* @__PURE__ */ reactExports.createElement("circle", _extends$k({}, concentricCircleProps, {
...
var ConcentricPolygon = (props) => {
  ...
  var concentricPolygonProps = _objectSpread$j({
    stroke: "#ccc",
    fill: "none"
  }, svgPropertiesNoEvents(props));
  return /* @__PURE__ */ reactExports.createElement("path", _extends$k({}, concentricPolygonProps, {
...
var ConcentricGridPath = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("g", {
  ...
  }, renderBackground && gridType === "circle" && /* @__PURE__ */ reactExports.createElement(ConcentricCircle, _extends$k({}, props, {
    radius: maxPolarRadius
  })), renderBackground && gridType !== "circle" && /* @__PURE__ */ reactExports.createElement(ConcentricPolygon, _extends$k({}, props, {
    radius: maxPolarRadius
  })), polarRadius.map((entry, i) => {
    var key = i;
    if (gridType === "circle") {
      return /* @__PURE__ */ reactExports.createElement(ConcentricCircle, _extends$k({
        key
      }, props, {
        fill: "none",
        radius: entry
    ...
    return /* @__PURE__ */ reactExports.createElement(ConcentricPolygon, _extends$k({
      key
    }, props, {
      fill: "none",
      radius: entry
...
var PolarGrid = (_ref2) => {
  ...
  } = _ref2, inputs = _objectWithoutProperties$k(_ref2, _excluded$k);
  ...
  }, /* @__PURE__ */ reactExports.createElement(ConcentricGridPath, _extends$k({
    gridType,
    radialLines
  }, props, {
    polarAngles,
    polarRadius
  })), /* @__PURE__ */ reactExports.createElement(PolarAngles, _extends$k({
    gridType,
    radialLines
  }, props, {
    polarAngles,
...
var _excluded$j = ["cx", "cy", "angle", "axisLine"], _excluded2$8 = ["angle", "tickFormatter", "stroke", "tick"];
function _extends$j() {
...
var getViewBox = (angle, cx, cy, ticks2) => {
  var maxRadiusTick = maxBy(ticks2, (entry) => entry.coordinate || 0);
  var minRadiusTick = minBy(ticks2, (entry) => entry.coordinate || 0);
  return {
    cx,
    cy,
    startAngle: angle,
...
var renderAxisLine = (props, ticks2) => {
  ...
  var extent = ticks2.reduce((result, entry) => [Math.min(result[0], entry.coordinate), Math.max(result[1], entry.coordinate)], [Infinity, -Infinity]);
  var point0 = polarToCartesian(cx, cy, extent[0], angle);
  var point1 = polarToCartesian(cx, cy, extent[1], angle);
  var axisLineProps = _objectSpread$i(_objectSpread$i(_objectSpread$i({}, svgPropertiesNoEvents(others)), {}, {
    fill: "none"
  ...
  return /* @__PURE__ */ reactExports.createElement("line", _extends$j({
...
var renderTickItem = (option, tickProps, value) => {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    tickItem = /* @__PURE__ */ reactExports.createElement(Text, _extends$j({}, tickProps, {
...
var renderTicks = (props, ticks2) => {
  var {
    ...
    stroke,
    tick
  } = props, others = _objectWithoutProperties$j(props, _excluded2$8);
  ...
  var items = ticks2.map((entry, i) => {
    ...
    return /* @__PURE__ */ reactExports.createElement(Layer, _extends$j({
...
var PolarRadiusAxisWrapper = (defaultsAndInputs) => {
  ...
  var props = _objectSpread$i(_objectSpread$i({}, defaultsAndInputs), {}, {
    scale
  }, viewBox);
  var {
    tick,
  ...
  }, axisLine && renderAxisLine(props, ticks2), tick && renderTicks(props, ticks2), /* @__PURE__ */ reactExports.createElement(PolarLabelContextProvider, getViewBox(props.angle, props.cx, props.cy, ticks2), /* @__PURE__ */ reactExports.createElement(PolarLabelFromLabelProp, {
    label: props.label
  }), props.children)));
};
...
function SetAngleAxisSettings(props) {
  ...
  var settings = reactExports.useMemo(() => {
    var {
      children
    } = props, rest = _objectWithoutProperties$i(props, _excluded$i);
    return rest;
  }, [props]);
...
var AxisLine$1 = (props) => {
  ...
  var axisLineProps = _objectSpread$h(_objectSpread$h({}, svgPropertiesNoEvents(props)), {}, {
    fill: "none"
  }, svgPropertiesNoEvents(axisLine));
  if (axisLineType === "circle") {
    return /* @__PURE__ */ reactExports.createElement(Dot, _extends$i({
  ...
  return /* @__PURE__ */ reactExports.createElement(Polygon, _extends$i({
    className: "recharts-polar-angle-axis-line"
  }, axisLineProps, {
    points
  }));
...
var TickItemText = (_ref2) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(Text, _extends$i({}, tickProps, {
...
var Ticks$1 = (props) => {
  ...
  var items = ticks2.map((entry, i) => {
    ...
    var tickProps = _objectSpread$h(_objectSpread$h(_objectSpread$h({}, axisProps), {}, {
    ...
    return /* @__PURE__ */ reactExports.createElement(Layer, _extends$i({
      className: clsx("recharts-polar-angle-axis-tick", getTickClassName(tick)),
      key: "tick-".concat(entry.coordinate)
    }, adaptEventsOfChild(props, entry, i)), tickLine && /* @__PURE__ */ reactExports.createElement("line", _extends$i({
...
var Trapezoid = (outsideProps) => {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ reactExports.createElement("g", null, /* @__PURE__ */ reactExports.createElement("path", _extends$h({}, svgPropertiesAndEvents(trapezoidProps), {
      className: layerClass,
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$h({}, svgPropertiesAndEvents(trapezoidProps), {
      className: layerClass,
...
var _excluded$h = ["option", "shapeType", "activeClassName"];
...
function Shape(_ref2) {
  ...
  } = _ref2, props = _objectWithoutProperties$h(_ref2, _excluded$h);
  var shape;
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
...
function DotItem(_ref2) {
  ...
  var _ref22 = dotProps !== null && dotProps !== void 0 ? dotProps : {}, {
    points
  } = _ref22, props = _objectWithoutProperties$g(_ref22, _excluded$g);
  return /* @__PURE__ */ reactExports.createElement(Dot, _extends$g({}, props, {
...
function Dots(_ref3) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex
  }, /* @__PURE__ */ reactExports.createElement(Layer, _extends$g({
    className
  }, layerProps), dots));
}
function ownKeys$d(e, r2) {
  ...
  reducers: {
    ...
    updateYAxisWidth(state, action) {
      ...
      if (axis) {
        ...
        state.yAxis[id] = _objectSpread$d(_objectSpread$d({}, state.yAxis[id]), {}, {
          width,
...
function RadarDotsWrapper(_ref2) {
  ...
  var {
    id
  } = props, propsWithoutId = _objectWithoutProperties$f(props, _excluded$f);
  ...
  if (isRange) {
    points.forEach((point2) => {
      if (Array.isArray(point2.value)) {
        ...
        baseLinePoints.push(_objectSpread$a(_objectSpread$a({}, point2), {}, {
          radius
...
function RadarLabelListProvider(_ref4) {
  ...
  var labelListEntries = points.map((point2) => {
    ...
    return _objectSpread$a(_objectSpread$a({}, viewBox), {}, {
      value: (_point$value = point2.value) !== null && _point$value !== void 0 ? _point$value : "",
      payload: point2.payload,
...
function StaticPolygon(_ref5) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(shape)) {
    ...
    radar = /* @__PURE__ */ reactExports.createElement(Polygon, _extends$f({}, svgPropertiesAndEvents(props), {
...
var interpolatePolarPoint = (prevPoints, prevPointsDiffFactor, t) => (entry, index) => {
  ...
  return _objectSpread$a(_objectSpread$a({}, entry), {}, {
    x: interpolate$1(entry.cx, entry.x, t),
    y: interpolate$1(entry.cy, entry.y, t)
  });
};
...
function RadarImpl(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RadarWithState, _extends$f({}, props, {
...
function Radar(outsideProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RegisterGraphicalItemId, {
    ...
    id
  }), /* @__PURE__ */ reactExports.createElement(RadarImpl, _extends$f({}, props, {
    id
  }))));
}
...
var _excluded$e = ["axisLine", "width", "height", "className", "hide", "ticks", "axisType"];
...
function AxisLine(axisLineProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement("line", _extends$e({}, props, {
...
function TickItem(props) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    tickItem = /* @__PURE__ */ reactExports.createElement(Text, _extends$e({}, tickProps, {
      className
    }), value);
  }
  return tickItem;
...
var Ticks = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  var tickLines = tickLineCoords.map((_ref2) => {
    ...
    }, tickLine && /* @__PURE__ */ reactExports.createElement("line", _extends$e({}, tickLineProps, lineCoord, {
...
var CartesianAxisComponent = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  var {
    ...
    ticks: ticks2,
    axisType
  } = props, rest = _objectWithoutProperties$e(props, _excluded$e);
...
var CartesianAxis = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(CartesianAxisComponent, _extends$e({}, props, {
    ref
  }));
});
CartesianAxis.displayName = "CartesianAxis";
var _excluded$d = ["x1", "y1", "x2", "y2", "key"], _excluded2$7 = ["offset"], _excluded3$3 = ["xAxisId", "yAxisId"], _excluded4$1 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    var {
      ...
      y2,
      key
    } = lineItemProps, others = _objectWithoutProperties$d(lineItemProps, _excluded$d);
    var _ref22 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(others)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
      offset: __
    } = _ref22, restOfFilteredProps = _objectWithoutProperties$d(_ref22, _excluded2$7);
    lineItem = /* @__PURE__ */ reactExports.createElement("line", _extends$d({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function HorizontalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$d(props, _excluded3$3);
...
function VerticalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$d(props, _excluded4$1);
...
function CartesianGrid(props) {
  ...
  }), /* @__PURE__ */ reactExports.createElement(HorizontalStripes, _extends$d({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ reactExports.createElement(VerticalStripes, _extends$d({}, propsIncludingDefaults, {
    verticalPoints
  })), /* @__PURE__ */ reactExports.createElement(HorizontalGridLines, _extends$d({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ reactExports.createElement(VerticalGridLines, _extends$d({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
...
var selectBandSize$1 = createSelector([selectChartLayout, selectXAxisWithScale$3, selectYAxisWithScale$3, selectXAxisTicks$3, selectYAxisTicks$3], (layout, xAxis, yAxis, xAxisTicks, yAxisTicks) => {
...
var selectLinePoints = createSelector([selectChartLayout, selectXAxisWithScale$3, selectYAxisWithScale$3, selectXAxisTicks$3, selectYAxisTicks$3, selectSynchronisedLineSettings, selectBandSize$1, selectChartDataWithIndexesIfNotInPanoramaPosition4], (layout, xAxis, yAxis, xAxisTicks, yAxisTicks, lineSettings, bandSize, _ref2) => {
  var {
    chartData,
    dataStartIndex,
    dataEndIndex
...
var _excluded$b = ["id"], _excluded2$6 = ["type", "layout", "connectNulls", "needClip", "shape"], _excluded3$2 = ["activeDot", "animateNewValues", "animationBegin", "animationDuration", "animationEasing", "connectNulls", "dot", "hide", "isAnimationActive", "label", "legendType", "xAxisId", "yAxisId", "id"];
function _extends$c() {
...
function LineDotsWrapper(_ref2) {
  ...
  var {
    id
  } = props, propsWithoutId = _objectWithoutProperties$b(props, _excluded$b);
...
function StaticCurve(_ref4) {
  ...
  var {
    ...
    needClip,
    shape
  } = props, others = _objectWithoutProperties$b(props, _excluded2$6);
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ reactExports.createElement(Shape, _extends$c({
    shapeType: "curve",
    option: shape
  }, curveProps, {
    pathRef
...
function LineImpl(props) {
  var _resolveDefaultProps = resolveDefaultProps(props, defaultLineProps), {
    ...
    yAxisId,
    id
  } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$b(_resolveDefaultProps, _excluded3$2);
  var {
    needClip
  } = useNeedsClip(xAxisId, yAxisId);
  var plotArea = usePlotArea();
  ...
  return /* @__PURE__ */ reactExports.createElement(LineWithState, _extends$c({}, everythingElse, {
    id,
    connectNulls,
    dot,
    activeDot,
...
function LineFn(outsideProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RegisterGraphicalItemId, {
    ...
    hide: props.hide,
    isPanorama
  }), /* @__PURE__ */ reactExports.createElement(LineImpl, _extends$c({}, props, {
    id
  }))));
}
...
var selectBandSize = createSelector([selectChartLayout, selectXAxisWithScale$2, selectYAxisWithScale$2, selectXAxisTicks$2, selectYAxisTicks$2], (layout, xAxis, yAxis, xAxisTicks, yAxisTicks) => {
  if (isCategoricalAxis(layout, "xAxis")) {
    return getBandSizeOfAxis(xAxis, xAxisTicks, false);
  }
  return getBandSizeOfAxis(yAxis, yAxisTicks, false);
...
var selectArea = createSelector([selectChartLayout, selectXAxisWithScale$2, selectYAxisWithScale$2, selectXAxisTicks$2, selectYAxisTicks$2, selectGraphicalItemStackedData, selectChartDataWithIndexesIfNotInPanoramaPosition3, selectBandSize, selectSynchronisedAreaSettings, selectChartBaseValue], (layout, xAxis, yAxis, xAxisTicks, yAxisTicks, stackedData, _ref2, bandSize, areaSettings, chartBaseValue) => {
  var {
    chartData,
    dataStartIndex,
    dataEndIndex
...
var _excluded$a = ["id"], _excluded2$5 = ["activeDot", "animationBegin", "animationDuration", "animationEasing", "connectNulls", "dot", "fill", "fillOpacity", "hide", "isAnimationActive", "legendType", "stroke", "xAxisId", "yAxisId"];
function _extends$b() {
...
function StaticArea(_ref4) {
  ...
  var {
    id
  } = props, propsWithoutId = _objectWithoutProperties$a(props, _excluded$a);
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ reactExports.createElement(Layer, {
    clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : void 0
  }, /* @__PURE__ */ reactExports.createElement(Curve, _extends$b({}, propsWithEvents, {
    id,
    points,
    connectNulls,
    type,
  ...
  })), stroke !== "none" && /* @__PURE__ */ reactExports.createElement(Curve, _extends$b({}, allOtherProps, {
    ...
    fill: "none",
    points
  })), stroke !== "none" && isRange && /* @__PURE__ */ reactExports.createElement(Curve, _extends$b({}, allOtherProps, {
    className: "recharts-area-curve",
    layout,
    type,
    connectNulls,
...
function AreaImpl(props) {
  ...
  var _resolveDefaultProps = resolveDefaultProps(props, defaultAreaProps), {
    ...
    xAxisId,
    yAxisId
  } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$a(_resolveDefaultProps, _excluded2$5);
  var layout = useChartLayout();
  var chartName = useChartName();
  var {
    needClip
  ...
  return /* @__PURE__ */ reactExports.createElement(AreaWithState, _extends$b({}, everythingElse, {
    activeDot,
    animationBegin,
    animationDuration,
    animationEasing,
...
function AreaFn(outsideProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RegisterGraphicalItemId, {
    ...
    isPanorama,
    connectNulls: props.connectNulls
  }), /* @__PURE__ */ reactExports.createElement(AreaImpl, _extends$b({}, props, {
    id
  }))));
}
...
var selectBarRectangles = createSelector([selectChartOffsetInternal, selectAxisViewBox, selectXAxisWithScale$1, selectYAxisWithScale$1, selectXAxisTicks$1, selectYAxisTicks$1, selectBarPosition, selectChartLayout, selectChartDataWithIndexesIfNotInPanoramaPosition3, selectAxisBandSize, selectStackedDataOfItem, selectSynchronisedBarSettings, pickCells$1], (offset, axisViewBox, xAxis, yAxis, xAxisTicks, yAxisTicks, pos, layout, _ref2, bandSize, stackedData, barSettings, cells) => {
  var {
    chartData,
    dataStartIndex,
    dataEndIndex
...
var _excluded$8 = ["onMouseEnter", "onMouseLeave", "onClick"], _excluded2$4 = ["value", "background", "tooltipPosition"], _excluded3$1 = ["id"], _excluded4 = ["onMouseEnter", "onClick", "onMouseLeave"];
function _extends$8() {
...
function BarBackground(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    ...
    var {
      ...
      tooltipPosition
    } = entry, rest = _objectWithoutProperties$8(entry, _excluded2$4);
...
function BarRectangleWithActiveState(props) {
  ...
  if (isActive) {
    ...
    }, /* @__PURE__ */ reactExports.createElement(BarRectangle, _extends$8({}, baseProps, {
  ...
  return /* @__PURE__ */ reactExports.createElement(BarRectangle, _extends$8({}, baseProps, {
    name: String(baseProps.name)
  }, entry, {
    isActive,
    option,
...
function BarRectangles(_ref3) {
  ...
  var _ref4 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
    id
  } = _ref4, baseProps = _objectWithoutProperties$8(_ref4, _excluded3$1);
  var {
    shape,
    dataKey,
    activeBar
  ...
  var {
    ...
    onClick: onItemClickFromProps,
    onMouseLeave: onMouseLeaveFromProps
  } = props, restOfAllOtherProps = _objectWithoutProperties$8(props, _excluded4);
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, data.map((entry, i) => {
    return /* @__PURE__ */ reactExports.createElement(BarStackClipLayer, _extends$8({
      index: i,
...
Bar.displayName = "Bar";
var _excluded$7 = ["option", "isActive"];
function _extends$7() {
...
function ScatterSymbol(_ref2) {
  ...
  if (typeof option === "string") {
    return /* @__PURE__ */ reactExports.createElement(Shape, _extends$7({
      option: /* @__PURE__ */ reactExports.createElement(Symbols, _extends$7({
        type: option
      }, props)),
      isActive,
      shapeType: "symbols"
...
var _excluded$6 = ["id"], _excluded2$3 = ["onMouseEnter", "onClick", "onMouseLeave"], _excluded3 = ["animationBegin", "animationDuration", "animationEasing", "hide", "isAnimationActive", "legendType", "lineJointType", "lineType", "shape", "xAxisId", "yAxisId", "zAxisId"];
...
var SetScatterTooltipEntrySettings = /* @__PURE__ */ reactExports.memo((_ref2) => {
  var {
    dataKey,
    points,
    stroke,
...
function ScatterLine(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(line)) {
    lineItem = /* @__PURE__ */ reactExports.cloneElement(line, lineProps);
  } else if (typeof line === "function") {
    lineItem = line(lineProps);
  } else {
    lineItem = /* @__PURE__ */ reactExports.createElement(Curve, _extends$6({}, lineProps, {
      type: lineJointType
    }));
  }
  return /* @__PURE__ */ reactExports.createElement(Layer, {
  ...
  var labelListEntries = reactExports.useMemo(() => {
    return points === null || points === void 0 ? void 0 : points.map((point2) => {
      ...
      var viewBox = {
        ...
        lowerWidth: point2.width,
        upperWidth: point2.width
      };
...
function ScatterSymbols(props) {
  ...
  var {
    id
  } = allOtherScatterProps, allOtherPropsWithoutId = _objectWithoutProperties$6(allOtherScatterProps, _excluded$6);
  var activeIndex = useAppSelector(selectActiveTooltipIndex);
  var {
    onMouseEnter: onMouseEnterFromProps,
    onClick: onItemClickFromProps,
    onMouseLeave: onMouseLeaveFromProps
  } = allOtherScatterProps, restOfAllOtherProps = _objectWithoutProperties$6(allOtherScatterProps, _excluded2$3);
  var onMouseEnterFromContext = useMouseEnterItemDispatch(onMouseEnterFromProps, dataKey, id);
  var onMouseLeaveFromContext = useMouseLeaveItemDispatch(onMouseLeaveFromProps);
  var onClickFromContext = useMouseClickItemDispatch(onItemClickFromProps, dataKey, id);
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement(ScatterLine, {
    points,
    ...
    var symbolProps = _objectSpread$2(_objectSpread$2(_objectSpread$2({}, baseProps), entry), {}, {
    ...
    return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
      ...
      onMouseLeave: onMouseLeaveFromContext(entry, i),
      onClick: onClickFromContext(entry, i)
    }), /* @__PURE__ */ reactExports.createElement(ScatterSymbol, _extends$6({
      option,
      isActive
    }, symbolProps))));
  }));
...
function SymbolsWithAnimation(_ref4) {
  ...
  var showLabels = !isAnimating;
  return /* @__PURE__ */ reactExports.createElement(ScatterLabelListProvider, {
    showLabels,
    points
  }, props.children, /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    animationId,
    ...
    var stepData = t === 1 ? points : points === null || points === void 0 ? void 0 : points.map((entry, index) => {
      ...
      if (prev) {
        return _objectSpread$2(_objectSpread$2({}, entry), {}, {
          cx: entry.cx == null ? void 0 : interpolate$1(prev.cx, entry.cx, t),
          cy: entry.cy == null ? void 0 : interpolate$1(prev.cy, entry.cy, t),
          size: interpolate$1(prev.size, entry.size, t)
        });
      }
      return _objectSpread$2(_objectSpread$2({}, entry), {}, {
        size: interpolate$1(0, entry.size, t)
      });
    });
    if (t > 0) {
      previousPointsRef.current = stepData;
    }
    return /* @__PURE__ */ reactExports.createElement(Layer, null, /* @__PURE__ */ reactExports.createElement(ScatterSymbols, {
      points: stepData,
...
function ScatterWithId(props) {
  ...
  }, /* @__PURE__ */ reactExports.createElement(SymbolsWithAnimation, {
    props,
    previousPointsRef
  })))));
}
...
function ScatterImpl(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement(SetScatterTooltipEntrySettings, {
    dataKey: props.dataKey,
    points,
    stroke: props.stroke,
    strokeWidth: props.strokeWidth,
    ...
    tooltipType: props.tooltipType,
    id: props.id
  }), /* @__PURE__ */ reactExports.createElement(ScatterWithId, _extends$6({}, everythingElse, {
    xAxisId,
    yAxisId,
    zAxisId,
    lineType,
...
function ScatterFn(outsideProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RegisterGraphicalItemId, {
    ...
    tooltipType: props.tooltipType,
    isPanorama
  }), /* @__PURE__ */ reactExports.createElement(ScatterImpl, _extends$6({}, props, {
    id
  }))));
}
var Scatter = /* @__PURE__ */ reactExports.memo(ScatterFn, propsAreEqual);
...
var ScatterChart = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  return /* @__PURE__ */ reactExports.createElement(CartesianChart, {
