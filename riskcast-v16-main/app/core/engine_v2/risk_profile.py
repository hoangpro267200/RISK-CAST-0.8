...
class RiskProfileBuilder:
    ...
    def identify_key_drivers(self, factors: Dict[str, float], top_n: int = 3) -> List[str]:
        """
        Identify key risk drivers (DEPRECATED - kept for backward compatibility)
        
        NOTE: This method is deprecated. The pipeline now uses derive_risk_drivers()
        from risk_driver_derivation module which implements strict Engine v3 rules.
