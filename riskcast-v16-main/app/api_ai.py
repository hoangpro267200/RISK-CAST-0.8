...
# CRITICAL: In production, fail if API key is missing or invalid
ENVIRONMENT = os.getenv("ENVIRONMENT", "development").lower()
is_production = ENVIRONMENT == "production"

if is_production:
    if not ANTHROPIC_API_KEY or ANTHROPIC_API_KEY == "dummy" or ANTHROPIC_API_KEY == "your_anthropic_api_key_here":
        raise ValueError(
            "ANTHROPIC_API_KEY is required in production. "
            "Set ANTHROPIC_API_KEY environment variable with a valid API key."
        )
